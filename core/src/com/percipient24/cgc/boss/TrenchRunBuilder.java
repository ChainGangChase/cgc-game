/*
 * @(#)TrenchRunBuilder.java		0.3 14/4/15
 * 
...
/*
 * Creates a trench run boss fight
 * 
 * @version 0.3 14/4/15
 * @author Christopher Rider
 */
public class TrenchRunBuilder extends BossBuilder 
{
	/*
	 * Creates a new TrenchRunBuilder
	 * 
	 * @param type					The type of boss for this builder
	 */
	public TrenchRunBuilder(BossType type) 
	{
		super(type);
		buildBossArea();
	}
	...
	private Array<Array<TerrainType>> createTerrain()
	{
		...
		final int MUD_CHANCE_MAX = 35;
		final int MUD_CHANCE_MIN = 5;
		...
		// Lake generation
		final int LAKE_POOL_MAX = 1100;
		final int LAKE_CHANCE_MAX = 25;
		final int LAKE_CHANCE_MIN = 6;
		int lakesUsed = 0;
	...
	private Array<Array<TerrainType>> createEntities()
	{
		...
		// Forest generation
		final int FOREST_POOL_MAX = 1100;
		final int FOREST_CHANCE_MIN = 2;
		final int FOREST_CHANCE_MAX = 9;
		int forestUsed = 0;
